  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="text-center mb-16">
        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-neon-blue to-neon-purple flex items-center justify-center mx-auto mb-6 shadow-neon-blue">
      ...
      <section className="mb-16">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            ...
            <div key={title} className="glass-card p-6 text-center" style={{ borderColor: `${color}20` }}>
      ...
      {/* Team */}
      <section className="mb-16">
        <h2 className="section-title mb-8">Meet the Team</h2>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {team.map((member) => (
            <div key={member.name} className="glass-card p-5 text-center">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-neon-blue/20 to-neon-purple/20 flex items-center justify-center mx-auto mb-3 text-3xl">
                {member.emoji}
              </div>
      ...
      {/* Stats */}
      <section className="glass-card p-8 text-center" style={{ background: 'linear-gradient(135deg, rgba(0,212,255,0.05), rgba(168,85,247,0.05))' }}>
        <h2 className="font-display font-bold text-2xl text-white mb-8">By the Numbers</h2>
