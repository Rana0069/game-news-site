...
export default async function Sidebar() {
  ...
  return (
    <aside className="space-y-6">
      ...
      {/* Newsletter mini */}
      <div className="glass-card p-5 bg-gradient-to-br from-neon-blue/5 to-neon-purple/5">
        ...
        <form action="/api/newsletter" method="POST">
          <input type="email" name="email" placeholder="your@email.com" className="input-dark mb-3" required />
